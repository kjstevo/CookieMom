    ...
    extends SummaryStatFragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (contentView_ == null) {
            contentView_ = inflater.inflate(layout.summary_stat_fragment, container, false);
        }
        return contentView_;
    }
    ...
    public static SummaryStatFragment_.FragmentBuilder_ builder() {
        return new SummaryStatFragment_.FragmentBuilder_();
    }
    ...
    public static class FragmentBuilder_ {
        ...
        public SummaryStatFragment build() {
            SummaryStatFragment_ fragment_ = new SummaryStatFragment_();
