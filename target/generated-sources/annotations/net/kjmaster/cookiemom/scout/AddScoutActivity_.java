...
public final class AddScoutActivity_
    ...
    private void afterSetContentView_() {
        addScoutDialogFragment = ((AddScoutDialogFragment) findSupportFragmentByTag());
        afterViews();
    }
    ...
    private Fragment findSupportFragmentByTag() {
        if (!(this instanceof FragmentActivity)) {
            return null;
        }
        FragmentActivity activity_ = ((FragmentActivity) this);
        return activity_.getSupportFragmentManager().findFragmentByTag("add_scout");
    }
