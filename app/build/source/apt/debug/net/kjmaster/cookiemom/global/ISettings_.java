    ...
    extends SharedPreferencesHelper
{
    ...
    public StringPrefField CookieList() {
        return stringField("CookieList", "Smiles,Trefoils,Do Si Dos,Samoas,Dulce,Berry,Tag-a-Longs,Thin Mint");
    }

    public BooleanPrefField useAutoFillCases() {
        return booleanField("useAutoFillCases", false);
    }

    public BooleanPrefField useCustomCookies() {
        return booleanField("useCustomCookies", false);
    }
        ...
        extends EditorHelper<ISettings_.ISettingsEditor_>
    {
        ...
        public BooleanPrefEditorField<ISettings_.ISettingsEditor_> useAutoFillCases() {
            return booleanField("useAutoFillCases");
        }

        public BooleanPrefEditorField<ISettings_.ISettingsEditor_> useCustomCookies() {
            return booleanField("useCustomCookies");
        }
