...
abstract class BaseDialogBuilder<T extends BaseDialogBuilder<T>> {
    ...
    protected final Class<? extends eu.inmite.android.lib.dialogs.BaseDialogFragment> mClass;
    ...
    public BaseDialogBuilder(Context context, FragmentManager fragmentManager, Class<? extends eu.inmite.android.lib.dialogs.BaseDialogFragment> clazz) {
